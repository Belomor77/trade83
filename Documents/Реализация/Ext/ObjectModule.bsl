...
//		
//		// Теперь поставим в начало заявку, на основании которой введен документ
//		стр=0;
//		Если ТИРезервы.НайтиЗначение(ДокОснование,стр,"ЗаявкаПокупателя")<>0 Тогда
//		   ТИРезервы.СдвинутьСтроку(-(стр-1),стр);
//		КонецЕсли;      
//	
//		ТекСтрока = 0;
