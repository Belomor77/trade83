...
//	Иначе
//		Сообщить("Неизвестный вид ТМЦ: "+пВидТМЦ);
//	КонецЕсли;
Возврат "";//	
...
//		глНеПроводить(Контекст, "Документом """+ глНазваниеДокументаВЖурнале(ТекущийДокумент()) +""" нельзя оформить поступление на оптовый склад!");
//		Возврат;
//	КонецЕсли;
//	
//	// Проведение по регистрам оперативного учета.	
